...
#       
#       path = sh("join", "/home/user", ('dir_one', 'dir_two'), "file.txt")        
...
#       
#       sh("mkdir -p", self.test_root, "one", ("two", "three"), "four")
#       
#       self.assertTrue(exists(test_path))
#       
...
#       self.assertRaises(FSException, lambda: sh("mkdir -p", test_path))
#       
#   def test_exists(self):
#       test_path = sh("join", self.test_root, "n1/n2/n3/n4/n5/n6")
#       
#       sh("mkdir -p", test_path)        
#       self.assertTrue(sh("exists", test_path))
#       
...
#       test_path = sh('join', self.test_root, 'a_file.txt')
#       
#       f = open(test_path, 'wb')
